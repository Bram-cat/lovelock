  ...
  const onboardingSteps = [
    {
      ...
      description:
        "Unlock the secrets of your relationships, personality, and life path through the ancient wisdom of numbers.",
      features: [
    ...
    },
    {
      ...
      description:
        "Get personalized numerology insights based on your birth date and name to understand your true potential.",
    ...
    },
    {
      ...
      description:
        "Discover how compatible you are with your partner using ancient numerological principles.",
      features: [
    ...
    },
    {
      ...
      description:
        "Understand the trust dynamics in your relationships and learn how to strengthen emotional bonds.",
      features: [
        "Trust compatibility",
    ...
    },
    {
      ...
      description:
        "Upgrade to Premium for unlimited readings, advanced insights, and personalized guidance.",
      features: [
        "Unlimited readings",
        ...
        <SafeAreaView style={styles.safeArea}>
          ...
          >
            ...
            {currentStepData.isPremium && (
              <GlassCard intensity="light" style={styles.pricingCard}>
                ...
                <Text style={styles.pricingDescription}>
                  Start your journey with unlimited access to all features.
                  Cancel anytime.
                </Text>
