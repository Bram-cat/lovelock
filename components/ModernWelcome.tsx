...
const WELCOME_STEPS: WelcomeStep[] = [
  {
    ...
    description:
      "Discover the ancient wisdom of numerology and astrology to unlock deeper insights about yourself and your relationships.",
    icon: "heart",
  ...
  },
  {
    ...
    description:
      "Your birth date holds the key to understanding your life path, destiny, and soul purpose through the power of numerology.",
    icon: "calculator",
  ...
  },
  {
    ...
    description:
      "Explore compatibility with potential partners using advanced numerological calculations and discover your ideal relationship dynamics.",
    icon: "people",
    ...
    image:
      "https://images.unsplash.com/photo-1516589178581-6cd7833ae3b2?w=400&h=300&fit=crop&crop=center",
  },
];
      ...
      <LinearGradient colors={step.gradient} style={styles.stepGradient}>
        ...
        <View style={styles.imageContainer}>
          <View style={styles.imagePlaceholder}>
            <LinearGradient
              colors={[`${String(step.gradient[0])}40`, `${String(step.gradient[1])}40`]}
          ...
          {WELCOME_STEPS.map((_, index) => (
            <View
              ...
              style={[
                ...
                {
                  backgroundColor:
                    index === currentStep ? "#fff" : "rgba(255,255,255,0.3)",
