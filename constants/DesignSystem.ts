...
export const DesignSystem = {
  colors: {
    ...
    backgrounds: {
      ...
      cosmicGradient: 'linear-gradient(135deg, #1a0033 0%, #000000 50%, #001a33 100%)',
      cardLight: '#F3E8FF',
    },
...
export const createCardStyle = (variant: keyof typeof DesignSystem.components.card.variants = 'cosmic') => ({
